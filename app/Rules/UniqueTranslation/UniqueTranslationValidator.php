...
namespace App\Rules\UniqueTranslation;
...
class UniqueTranslationValidator
{
    ...
    {
        [$name, $locale] = $this->isNovaTranslation($attribute)
    ...
    protected function getAttributeNameAndLocale($attribute, $delimiter)
    {
        ...
        return [$name, $locale ? $locale : App::getLocale()];
    }
    ...
    {
        [$connection, $table] = $this->getConnectionAndTable($parameters);
